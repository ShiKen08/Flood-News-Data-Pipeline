...
KNOWN_ALIASES: dict[str, list[str]] = {
    ...
    "aldaya":                 ["aldaia"],
    # ── USA — flood_65: Kerr County, Texas ─────────────────────────────────────
    "kerr county":            ["kerr", "kerr co", "kerrville", "ingram", "center point",
                               "hill country", "texas hill country", "guadalupe river"],
    "kerrville":              ["kerrville tx", "kerrville texas"],
    "ingram":                 ["ingram tx", "ingram texas"],
    # ── USA — flood_128: Roswell / Chaves County, NM ───────────────────────────
    "chaves county":          ["roswell", "roswell nm", "roswell new mexico",
                               "eastern new mexico", "pecos river", "chaves co"],
    "roswell":                ["roswell nm", "roswell new mexico", "chaves county"],
    # ── USA — flood_62: Ruidoso, New Mexico ────────────────────────────────────
    "ruidoso":                ["ruidoso nm", "ruidoso new mexico", "ruidoso downs",
                               "lincoln county", "village of ruidoso"],
    "lincoln county":         ["lincoln county nm", "lincoln co"],
    # ── USA — flood_71: San Antonio / Greater Bexar, Texas ─────────────────────
    "san antonio":            ["san antonio tx", "san antonio texas", "bexar county",
                               "bexar co", "greater san antonio"],
    "bexar county":           ["bexar co", "san antonio"],
    # ── USA — flood_9: California counties ─────────────────────────────────────
    "san bernardino":         ["san bernardino county", "san bernardino co",
                               "inland empire"],
    # ── USA — flood_61: NJ/NY/VA/PA flood ──────────────────────────────────────
    "middlesex county":       ["middlesex", "middlesex county nj", "middlesex nj"],
    "union county":           ["union county nj", "union nj"],
    "somerset county":        ["somerset county nj", "somerset nj"],
    "lancaster county":       ["lancaster county pa", "lancaster pa"],
    "petersburg":             ["petersburg va", "petersburg virginia"],
    # ── COL — flood_3: Colombian departments ───────────────────────────────────
    "córdoba":                ["cordoba", "córdoba department", "cordoba department"],
    "sucre":                  ["sucre department", "sucre dept"],
    "cauca":                  ["cauca department", "cauca dept"],
    "narino":                 ["nariño", "narino department", "nariño department"],
    "nariño":                 ["narino", "nariño department"],
    # ── BOL — flood_15: Santa Cruz / Beni / Cochabamba ─────────────────────────
    "santa cruz":             ["santa cruz department", "santa cruz dept",
                               "el torno", "la guardia", "cotoca"],
    "el torno":               ["el torno municipality", "el torno santa cruz"],
    "la guardia":             ["la guardia municipality", "la guardia santa cruz"],
    "cotoca":                 ["cotoca municipality", "cotoca santa cruz"],
    "beni":                   ["beni department", "beni dept", "el beni"],
    # ── BOL — flood_108: Multi-department Bolivia ───────────────────────────────
    "chuquisaca":             ["chuquisaca department", "chuquisaca dept", "sucre capital"],
    "tarija":                 ["tarija department", "tarija dept"],
    "potosí":                 ["potosi", "potosí department", "potosi department"],
    # ── CRI — flood_21: Costa Rica regions ─────────────────────────────────────
    "alajuela":               ["alajuela province", "alajuela canton"],
    "cartago":                ["cartago province", "cartago canton"],
    "guanacaste":             ["guanacaste province", "nicoya peninsula"],
    "nicoya":                 ["nicoya canton", "nicoya guanacaste"],
    "puntarenas":             ["puntarenas province", "puntarenas canton",
                               "golfito", "corredores", "osa"],
    "golfito":                ["golfito canton", "golfito puntarenas"],
    # ── HND — flood_22: Honduras departments ───────────────────────────────────
    "francisco morazán":      ["francisco morazan", "morazan", "tegucigalpa",
                               "francisco morazán department"],
    "francisco morazan":      ["francisco morazán", "morazan", "tegucigalpa"],
    "intibucá":               ["intibuca", "intibucá department"],
    "intibuca":               ["intibucá", "intibuca department"],
    "lempira":                ["lempira department", "lempira dept"],
    # ── MEX — flood_23: Mexican states ─────────────────────────────────────────
    "veracruz":               ["veracruz state", "estado de veracruz", "veracruz-llave"],
    "puebla":                 ["puebla state", "estado de puebla"],
    "hidalgo":                ["hidalgo state", "estado de hidalgo"],
    "san luis potosí":        ["san luis potosi", "slp", "san luis potosí state"],
    "san luis potosi":        ["san luis potosí", "slp"],
    "querétaro":              ["queretaro", "querétaro state", "queretaro state"],
    # ── MEX — flood_60: Jalisco ─────────────────────────────────────────────────
    "jalisco":                ["jalisco state", "estado de jalisco"],
    "la martinica":           ["la martinica jalisco", "martinica"],
    # ── BRA — flood_88: Rio de Janeiro / São Paulo ───────────────────────────────
    "petrópolis":             ["petropolis", "petropolis rj", "petrópolis rj",
                               "petrópolis rio de janeiro"],
    "petropolis":             ["petrópolis", "petropolis rj"],
    "angra dos reis":         ["angra dos reis rj", "angra"],
    "rio de janeiro":         ["rio", "rj", "estado do rio de janeiro", "rio de janeiro state"],
    "são paulo":              ["sao paulo", "sp", "estado de são paulo",
                               "são paulo state", "sao paulo state"],
    "sao paulo":              ["são paulo", "sp"],
    # ── BRA — flood_110: Carapicuíba, SP ────────────────────────────────────────
    "carapicuíba":            ["carapicuiba", "carapicuíba sp", "carapicuiba sp",
                               "carapicuíba são paulo"],
    "carapicuiba":            ["carapicuíba", "carapicuiba sp"],
    # ── ARG — flood_97: Bahía Blanca ────────────────────────────────────────────
    "bahia blanca":           ["bahía blanca", "bahia blanca city", "bahía blanca city",
                               "bbca", "partido de bahía blanca"],
    "bahía blanca":           ["bahia blanca", "bahía blanca city", "bbca"],
    "buenos aires":           ["buenos aires province", "provincia de buenos aires",
                               "bonaerense", "pba"],
    # ── PER — flood_99: Multi-region Peru ──────────────────────────────────────
    "áncash":                 ["ancash", "áncash region", "ancash region"],
    "ancash":                 ["áncash", "ancash region"],
    "apurímac":               ["apurimac", "apurímac region", "apurimac region"],
    "apurimac":               ["apurímac", "apurimac region"],
    "arequipa":               ["arequipa region", "arequipa city"],
    "ayacucho":               ["ayacucho region", "ayacucho dept"],
    "cusco":                  ["cuzco", "cusco region", "cuzco region"],
    "huancavelica":           ["huancavelica region"],
    "huánuco":                ["huanuco", "huánuco region", "huanuco region"],
    "huanuco":                ["huánuco", "huanuco region"],
    "junín":                  ["junin", "junín region", "junin region"],
    "junin":                  ["junín", "junin region"],
    "la libertad":            ["la libertad region", "la libertad peru"],
    "moquegua":               ["moquegua region"],
    "pasco":                  ["pasco region", "pasco dept"],
    "piura":                  ["piura region", "piura city"],
    "tacna":                  ["tacna region", "tacna city"],
    "tumbes":                 ["tumbes region"],
    "ucayali":                ["ucayali region"],
    "amazonas":               ["amazonas region", "amazonas peru"],
    # ── PER — flood_104: Puno ──────────────────────────────────────────────────
    "puno":                   ["puno region", "puno dept", "lago titicaca"],
    "tiquillaca":             ["tiquillaca district", "tiquillaca puno"],
    # ── DOM — flood_124: Dominican Republic provinces ───────────────────────────
    "duarte":                 ["duarte province", "provincia duarte"],
    "el seibo":               ["el seybo", "el seibo province"],
    "espaillat":              ["espaillat province"],
    "hato mayor":             ["hato mayor province", "hato mayor del rey"],
    "la altagracia":          ["altagracia", "la altagracia province", "punta cana area"],
    "samaná":                 ["samana", "samaná province", "samana province"],
    "samana":                 ["samaná", "samana province"],
    "puerto plata":           ["puerto plata province"],
    "maría trinidad sánchez": ["maria trinidad sanchez", "nagua"],
    "maria trinidad sanchez": ["maría trinidad sánchez", "nagua"],
}
